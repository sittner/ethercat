...
/**
 * Check if a transport type is available (wrapper).
 */
static int ec_transport_type_available(ec_transport_type_t type)
{
    return ec_transport_available(type);
}

/**
 * Get transport type name (wrapper).
 */
static const char *ec_transport_type_name(ec_transport_type_t type)
{
    switch (type) {
...
void ecrt_master_idle(unsigned int master_index)
{
    ...
    /* TODO: Implement idle processing in Phase 3
...
int ecrt_master_process_control(unsigned int master_index)
{
    ...
    /* TODO: Implement control interface processing in Phase 4
