...
typedef struct
{
    ...
    ec_eoe_buf_t skb; /**< socket buffer */
}
ec_eoe_frame_t;
...
struct ec_eoe
{
    ...
    ec_eoe_netdev_t dev; /**< net_device for virtual ethernet device */
    ec_eoe_stats_t stats; /**< device statistics */
    unsigned int opened; /**< net_device is opened */
    ec_time_t rate_time; /**< time of last rate output */

    ec_eoe_buf_t rx_skb; /**< current rx socket buffer */
