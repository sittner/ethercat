...
{
    ec_fsm_change_t fsm_change; /**< State change state machine (owned). */
    ec_fsm_coe_t fsm_coe; /**< CoE state machine (owned). */
    ec_fsm_soe_t fsm_soe; /**< SoE state machine (owned). */
    ec_fsm_pdo_t fsm_pdo; /**< PDO configuration state machine (owned). */
    ec_fsm_eoe_t fsm_eoe; /**< EoE state machine (owned). */

    ec_slave_t *slave; /**< Slave the FSM runs on. */
    void (*state)(ec_fsm_slave_config_t *, ec_datagram_t *); /**< State
                                                               function. */
    unsigned int retries; /**< Retries on datagram timeout. */
    ec_sdo_request_t *request; /**< SDO request for SDO configuration. */
    ec_sdo_request_t request_copy; /**< Copied SDO request. */
    ec_soe_request_t *soe_request; /**< SoE request for SoE configuration. */
    ec_soe_request_t soe_request_copy; /**< Copied SoE request. */
